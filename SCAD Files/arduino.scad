...
module PowerPlug(extended)
{
	if(extended == 1)
	{
		translate([-26.893, -47.4929962-1, board_height-.6])
		color([0.3, 0.3, 0.3])
		cube([24, 9+.6, 11+1]);
	}
	else
	{
		translate([-16.893, -47.4929962-1, board_height-.6])
		color([0.3, 0.3, 0.3])
		cube([14, 9+.6, 11+1]);
	}
}
...
module USB(extended)
{
	if(extended == 1)
	{
		translate([-31.465, -18.5623962-1, board_height-.6])
		color([0.8, 0.8, 0.8])
		cube([26, 12+1.4, 11+1]);
	}
	else
	{
		translate([-21.465, -18.5623962-1, board_height-.6])
		color([0.8, 0.8, 0.8])
		cube([16, 12+1.4, 11+1]);
	}
}
